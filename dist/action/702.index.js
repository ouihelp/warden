...
let wasm;
const { TextEncoder, TextDecoder } = __webpack_require__(39023);
...
const path = __webpack_require__.ab + "photon_rs_bg.wasm";
const bytes = (__webpack_require__(79896).readFileSync)(__webpack_require__.ab + "photon_rs_bg.wasm");
