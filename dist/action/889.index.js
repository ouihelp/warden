...
/* harmony import */ var _utils_error_body_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(43307);
/* harmony import */ var _utils_event_stream_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(89533);
/* harmony import */ var _utils_hash_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(65078);
/* harmony import */ var _utils_headers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(56814);
/* harmony import */ var _utils_json_parse_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21034);
...
/* harmony import */ var _utils_provider_retry_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(63132);
/* harmony import */ var _utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(30883);
/* harmony import */ var _constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(25155);
/* harmony import */ var _github_copilot_headers_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(78832);
/* harmony import */ var _openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(40549);
/* harmony import */ var _simple_options_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(51821);
/* harmony import */ var _transform_messages_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(75702);
...
const stream = (model, context, options) => {
    ...
    (async () => {
        ...
        try {
            ...
            const grammarToolInputProperties = (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .createGrammarToolInputProperties */ .PJ)(context.tools, compat.supportsOpenAIGrammarTools);
            ...
            const { data: openaiStream, response } = await (0,_utils_provider_retry_js__WEBPACK_IMPORTED_MODULE_4__/* .retryProviderRequest */ .T)(() => client.chat.completions.create(params, requestOptions).withResponse(), {
            ...
            const appendCustomToolCallInput = (block, nextInput, close) => {
                ...
                if (!customInput)
                    return undefined;
                const delta = (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .appendGrammarToolInputJsonDelta */ .eW)(customInput.jsonBuffer, customInput.property, nextInput, close);
            ...
            const finishBlock = (block) => {
                ...
                if (block.type === "text") {
                    ...
                    if (block.customInput) {
                        ...
                        block.arguments = (0,_utils_json_parse_js__WEBPACK_IMPORTED_MODULE_6__/* .parseStreamingJson */ .o2)(block.partialArgs);
                    }
            ...
            output.errorMessage = (0,_utils_error_body_js__WEBPACK_IMPORTED_MODULE_7__/* .formatProviderError */ .lR)((0,_utils_error_body_js__WEBPACK_IMPORTED_MODULE_7__/* .normalizeProviderError */ .Jo)(error));
...
function buildParams(model, context, options, compat = getCompat(model), cacheRetention = resolveCacheRetention(options?.cacheRetention, options?.env), grammarToolInputProperties = (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .createGrammarToolInputProperties */ .PJ)(context.tools, compat.supportsOpenAIGrammarTools)) {
    ...
    const params = {
        ...
        prompt_cache_key: (model.baseUrl.includes("api.openai.com") && cacheRetention !== "none") ||
            ...
            ? (0,_openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_12__/* .clampOpenAIPromptCacheKey */ .l)(options?.sessionId)
            : undefined,
...
function resolveClampedThinkingBudget(model, options, params) {
    ...
    const budget = (0,_simple_options_js__WEBPACK_IMPORTED_MODULE_8__/* .clampThinkingBudgetToAnswerRoom */ .z9)((0,_simple_options_js__WEBPACK_IMPORTED_MODULE_8__/* .thinkingBudgetForLevel */ .pT)(options.reasoningEffort, options.thinkingBudgets), ceiling);
...
function convertMessages(model, context, compat, options) {
    ...
    const normalizeToolCallId = (id) => {
        ...
        if (id.includes("|")) {
            ...
            const hash = (0,_utils_hash_js__WEBPACK_IMPORTED_MODULE_13__/* .shortHash */ .B)(id).slice(0, 8);
    ...
    const transformedMessages = (0,_transform_messages_js__WEBPACK_IMPORTED_MODULE_14__/* .transformMessages */ .b)(context.messages, model, (id) => normalizeToolCallId(id));
    if (context.systemPrompt) {
        const useDeveloperRole = model.reasoning && compat.supportsDeveloperRole;
        const role = useDeveloperRole ? "developer" : "system";
        params.push({ role: role, content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__/* .sanitizeSurrogates */ .J)(context.systemPrompt) });
    }
    let lastRole = null;
    for (let i = 0; i < transformedMessages.length; i++) {
        ...
        if (msg.role === "user") {
            if (typeof msg.content === "string") {
                params.push({
                    role: "user",
                    content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__/* .sanitizeSurrogates */ .J)(msg.content),
                });
            }
            else {
                const content = msg.content.map((item) => {
                    if (item.type === "text") {
                        return {
                            type: "text",
                            text: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__/* .sanitizeSurrogates */ .J)(item.text),
                        };
                    }
                    else {
                        return {
            ...
            const assistantTextParts = msg.content
                ...
                .map((block) => ({
                type: "text",
                text: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__/* .sanitizeSurrogates */ .J)(block.text),
            }));
            ...
            if (nonEmptyThinkingBlocks.length > 0) {
                if (compat.requiresThinkingAsText) {
                    ...
                    const thinkingText = nonEmptyThinkingBlocks
                        .map((block) => (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__/* .sanitizeSurrogates */ .J)(block.thinking))
                        .join("\n\n");
                ...
                assistantMsg.tool_calls = toolCalls.map((tc) => {
                    ...
                    if (customInputProperty !== undefined) {
                        return {
                            ...
                            custom: {
                                name: tc.name,
                                input: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__/* .sanitizeSurrogates */ .J)((0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .getGrammarToolInput */ .gY)(tc.name, tc.arguments, customInputProperty)),
                            },
                        };
                    }
                    return {
            ...
            for (; j < transformedMessages.length && transformedMessages[j].role === "toolResult"; j++) {
                ...
                const toolResultMsg = {
                    role: "tool",
                    content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_15__/* .sanitizeSurrogates */ .J)(toolResultText),
...
function convertTools(tools, compat) {
    return tools.map((tool) => {
        const grammar = (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .resolveGrammarConstrainedSampling */ .TH)(tool, compat.supportsOpenAIGrammarTools);
        if (grammar) {
            return {
                type: "custom",
                custom: {
        ...
        const strict = (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .resolveJsonSchemaStrictSampling */ ._F)(tool, compat.supportsStrictMode !== false);
        return {
            type: "function",
            function: {
                name: tool.name,
                description: tool.description,
                parameters: (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .getJsonSchemaToolParameters */ .Km)(tool, strict),
...
function parseChunkUsage(rawUsage, model) {
    ...
    (0,_models_js__WEBPACK_IMPORTED_MODULE_9__/* .calculateCost */ .yN)(model, usage);
    return usage;
}
